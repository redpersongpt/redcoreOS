...
# Target: Ubuntu 24.04 @ 185.48.182.164
...
DOMAIN="redcoreos.net"
CERTBOT_EMAIL="redpersoncoding@gmail.com"  # ← REPLACE THIS
...
if [[ "$CERTBOT_EMAIL" == "redpersoncoding@gmail.com" ]]; then
...
echo "    scp file.exe ubuntu@185.48.182.164:$DOWNLOADS_DIR/os/"
echo ""
