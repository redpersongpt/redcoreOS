...
echo "  2. Point DNS: redcoreos.net → 185.48.182.164"
echo "  3. Point DNS: tuning-api.redcoreos.net → 185.48.182.164"
echo "  4. Point DNS: os-api.redcoreos.net → 185.48.182.164"
echo "  5. Point DNS: api.redcoreos.net → 185.48.182.164"
