...
export const strategyQuestions: StrategyQuestionDefinition[] = [
  ...
  makeBooleanQuestion(
    ...
    "Wrench",
    "Context Menu",
    "Restore classic context menu and clean shell clutter?",
    "Restores the full right-click menu on Windows 11, then removes clutter entries: Share, Give access to, Cast to device, Include in library, Troubleshoot compatibility, and Edit with Paint 3D.",
    "Yes — restore and clean up the context menu",
    "Full classic menu plus removal of 6 unused shell extension entries.",
    "No — keep the stock context menu",
    "Leave the modern compact menu and all shell entries intact.",
  ),
  makeBooleanQuestion(
    "enableEndTask",
    "Wrench",
  ...
  makeBooleanQuestion(
    ...
    "Cpu",
    "Memory Tuning",
    "Apply memory subsystem optimizations?",
    "Bundles memory compression disable, NDU leak fix, prefetch disable, svchost split optimization, and page combining control. Best on 16GB+ systems with SSD.",
    "Yes — optimize memory subsystem",
    "Less CPU overhead, fixed NDU memory leak, reduced background I/O from prefetch.",
    "No — keep Windows memory defaults",
    "Safer if you want Windows to manage memory conservatively.",
    {
      visibility: { minPreset: "balanced" },
    },
  ),
  ...
  makeBooleanQuestion(
    ...
    "Globe",
    "Legacy Protocols",
    "Disable insecure legacy network protocols (LLMNR, SMBv1, WPAD)?",
    "Bundles three well-known protocol hardening actions: LLMNR name poisoning prevention, SMBv1 (WannaCry vector) removal, and WPAD proxy auto-discovery disable.",
    "Yes — disable legacy protocols",
    "Reduces attack surface by removing protocols exploited in real-world attacks.",
    "No — keep legacy protocols",
    "Leave LLMNR, SMBv1, and WPAD intact for compatibility.",
    {
      visibility: { minPreset: "aggressive" },
    },
  ),
