...
import { Download, Check, AlertTriangle, Globe, Wrench, Gamepad2, MessageCircle, Monitor, Code, Music, Film, Package, Cpu } from "lucide-react";
  ...
  if (loading) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3">
        ...
        <p className="text-[12px] text-ink-secondary">Loading app catalog...</p>
      </div>
    );
  }
